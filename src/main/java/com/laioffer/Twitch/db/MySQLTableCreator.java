...
import com.laioffer.Twitch.db.MySQLDBUtil;
...
public class MySQLTableCreator {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 通过statement执行语句 // read executeQuery  write executeUpdate
            if (conn == null) {
                return;
            }

            // Step 2 Drop tables in case they exist.
            // 有顺序，先删除favorite 有foreign key的 再删除其他的
            ...
            // 创建顺序相反
            // jackson: json -> class name
            // orm: object related model: java class -> database table
            // JTA interface 一套标准 -> hibernate
